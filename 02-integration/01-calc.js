...
try {
  ...
  if (result !== 3) throw new Error('Expected calc("divide", 9, 9); to be 3. Received: ' + result);
  ...
  if (result == isNaN) throw new Error('Expected calc("exponent", 2, 8); to be Nan. Received: ' + result);
