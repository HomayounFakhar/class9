...
try {
  ...
  if (result == isNaN) throw new Error('Expected difference(1) to be NaN. Received: ' + result);
  ...
  if (result == isNaN) throw new Error('Expected difference() to be NaN. Received: ' + result);  
